...
//                mDrawerLayout!!.closeDrawers()
    ...
    private fun updateDrawerTogglesByOptions(options: CropImageViewOptions) {
        ...
        (findViewById<View>(R.id.drawer_option_toggle_guidelines) as TextView).text =
            resources
                .getString(R.string.drawer_option_toggle_guidelines, options.guidelines.name)
        (findViewById<View>(R.id.drawer_option_toggle_multitouch) as TextView).text =
            resources
                .getString(
        ...
        (findViewById<View>(R.id.drawer_option_toggle_auto_zoom) as TextView).text =
            resources
                .getString(
